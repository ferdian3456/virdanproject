...
CREATE TABLE "public"."server_post_images" ("id" uuid NOT NULL, "bucket" character varying(50) NOT NULL, "object_key" character varying(255) NOT NULL, "mime_type" character varying(50) NOT NULL, "size" bigint NOT NULL, "width" integer NULL, "height" integer NULL, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, "created_by" uuid NOT NULL, "updated_by" uuid NOT NULL, PRIMARY KEY ("id"));
-- Create "server_post_videos" table
CREATE TABLE "public"."server_post_videos" ("id" uuid NOT NULL, "bucket" character varying(50) NOT NULL, "object_key" character varying(255) NOT NULL, "mime_type" character varying(50) NOT NULL, "size" bigint NOT NULL, "duration" integer NOT NULL, "width" integer NOT NULL, "height" integer NOT NULL, "thumbnail_object_key" character varying(255) NOT NULL, "mirrored" boolean NOT NULL DEFAULT false, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, "created_by" uuid NOT NULL, "updated_by" uuid NOT NULL, PRIMARY KEY ("id"));
-- Create "server_posts" table
CREATE TABLE "public"."server_posts" ("id" uuid NOT NULL, "server_id" uuid NOT NULL, "author_id" uuid NOT NULL, "post_image_id" uuid NULL, "post_video_id" uuid NULL, "caption" text NOT NULL, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, "created_by" uuid NOT NULL, "updated_by" uuid NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "server_posts_author_id_fkey" FOREIGN KEY ("author_id") REFERENCES "public"."users" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT, CONSTRAINT "server_posts_post_image_id_fkey" FOREIGN KEY ("post_image_id") REFERENCES "public"."server_post_images" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, CONSTRAINT "server_posts_post_video_id_fkey" FOREIGN KEY ("post_video_id") REFERENCES "public"."server_post_videos" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, CONSTRAINT "server_posts_server_id_fkey" FOREIGN KEY ("server_id") REFERENCES "public"."servers" ("id") ON UPDATE NO ACTION ON DELETE CASCADE, CONSTRAINT "chk_post_media_exclusive" CHECK ((post_image_id IS NOT NULL AND post_video_id IS NULL) OR (post_image_id IS NULL AND post_video_id IS NOT NULL)));
