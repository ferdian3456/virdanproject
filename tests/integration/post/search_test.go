...
func createPostWithCaption(t *testing.T, app *fiber.App, redisURL, token, serverID, caption string) string {
	t.Helper()
...
func TestSearchPosts_Success(t *testing.T) {
	...
	createPostWithCaption(t, app, globalInfra.RedisURL, token, serverID, "morning coffee run")
	createPostWithCaption(t, app, globalInfra.RedisURL, token, serverID, "late night code")
...
func TestSearchPosts_NoMatch(t *testing.T) {
	...
	createPostWithCaption(t, app, globalInfra.RedisURL, token, serverID, "hello world")
...
func TestSearchPosts_NotAMember(t *testing.T) {
	...
	createPostWithCaption(t, app, globalInfra.RedisURL, ownerToken, serverID, "secret coffee")
